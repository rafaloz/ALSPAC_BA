...
def model_evaluation_MCCQR_MLP(X_train, X_test, results, features):
    ...
    file_path = ('/home/rafa/PycharmProjects/Cardiff_ALSPAC/modelos/modelo_morfo_100/SimpleMLP_nfeats_100_fold_0.pkl')
    ...
    # bias correction
    df_bias_correction = pd.read_csv('/home/rafa/PycharmProjects/Cardiff_ALSPAC/modelos/modelo_morfo_100/DataFrame_bias_correction.csv')
...
X_test_Cardiff = pd.read_csv('/home/rafa/PycharmProjects/JoinData_FastSurfer_V2/Scripts_Join_data/Datos_per_DB/CARDIFF_PE_I_FastSurfer_V2_data.csv')

# List of IDs to remove
ids_to_remove = ['15382A_brain', '19674A_brain', '20606A_brain', '13123A_brain', '17524A_brain']

# IDs_in_II = ['10278A_brain', '10847A_brain', '11493A_brain', '12313A_brain', '12989A_brain', '14095A_brain',
#             '15382A_brain', '16358A_brain', '19582A_brain', '20751A_brain', '207A_brain', '21080A_brain',
#            '2573A_brain', '4089A_brain']

# IDs_Longi = ['10057A_brain', '11515A_brain', '11849A_brain', '12814A_brain', '13968A_brain', '1424A_brain', '14668A_brain', '15080A_brain', '16273A_brain', '16406A_brain', '17096A_brain', '1759A_brain', '1969A_brain', '20540A_brain', '3191A_brain', '3469A_brain', '7681A_brain', '7708A_brain', '8337A_brain', '8887A_brain', '943A_brain', '10221A_brain', '1058A_brain', '10874A_brain', '11210A_brain', '1125A_brain', '11491A_brain', '12367A_brain', '12421A_brain', '12604A_brain', '13194A_brain', '13921A_brain', '14194A_brain', '16211A_brain', '16417A_brain', '16796A_brain', '1687A_brain', '1708A_brain', '17169A_brain', '18944A_brain', '19843A_brain', '232A_brain', '2358A_brain', '2932A_brain', '3005A_brain', '3943A_brain', '4103A_brain', '4760A_brain', '5656A_brain', '5761A_brain', '5769A_brain', '6395A_brain', '6398A_brain', '6497A_brain', '6545A_brain', '7507A_brain', '8010A_brain', '8705A_brain', '9384A_brain', '9467A_brain', '9537A_brain', '10008A_brain', '10514A_brain', '13098A_brain', '13672A_brain', '16973B_brain', '18452A_brain', '4282A_brain', '712A_brain', '10088A_brain', '11310A_brain', '13387A_brain', '1453A_brain', '19047A_brain', '2500A_brain', '3137A_brain', '4345A_brain', '79A_brain', '8092A_brain', '12896A_brain', '15027A_brain', '18314A_brain', '21097A_brain', '21174A_brain', '3717A_brain', '6878A_brain', '13022A_brain', '13419A_brain', '13790A_brain', '15124A_brain', '16423A_brain', '17192A_brain', '18069A_brain', '20643A_brain', '21268A_brain', '2179A_brain', '3073A_brain', '4422A_brain', '6081A_brain', '7467A_brain', '762A_brain', '12313A_brain', '12989A_brain', '14095A_brain', '10278A_brain', '11493A_brain', '16358A_brain', '19582A_brain', '20751A_brain', '207A_brain', '21080A_brain', '2573A_brain', '4089A_brain']

# Filter out the rows with these IDs
X_test_Cardiff = X_test_Cardiff[~X_test_Cardiff['ID'].isin(ids_to_remove)]
# X_test_Cardiff = X_test_Cardiff[~X_test_Cardiff['ID'].isin(IDs_in_II)]
...
for group, name in [(healthyALSPAC, "Healthy"), (crazyALSPAC, "Crazy")]:
    ...
    print(f"{name} Group - Shapiro-Wilk Test: Stat={stat}, P-value={p_value}")
    if p_value < 0.05:
...
# Welch's mann-whitney for Age assuming unequal variances
t_stat, p_value_age = stats.mannwhitneyu(healthyALSPAC['brainPAD_standardized'], crazyALSPAC['brainPAD_standardized'], alternative='two-sided')
print("Mann-Whiteney U test for brainPAD_standardized:")
print(f"Mann-Whiteney U: {t_stat}, P-value: {p_value_age}")
if p_value_age < 0.05:
...
if shapiro_trend.pvalue > 0.05:  # Normality assumption check
    if levene_test.pvalue > 0.05:  # Homogeneity of variances check
        ...
        print("\nHomogeneity of variances violated. Proceeding to Welch-ANCOVA.")
        # Perform Welch-ANCOVA using WLS
        group_var = 'Group'  # Replace with your actual grouping variable name
        dependent_var = 'brainPAD_standardized'
...
# Shapiro-Wilk Test for Normality within each group
print("Shapiro-Wilk Test Results for Normality (Edad):")
for group in sorted(merged_df['pliks18TH'].unique()):
    sample = merged_df[merged_df['pliks18TH'] == group]['Edad']
    # Apply the Shapiro-Wilk test for normality
    stat, p_value = stats.shapiro(sample)
    print(f"Group {group}: Shapiro-Wilk Statistic={stat:.4f}, p-value={p_value}")

# Levene's Test for Homogeneity of Variances
w, p_value = stats.levene(*[merged_df[merged_df['pliks18TH'] == group]['Edad'] for group in sorted(merged_df['pliks18TH'].unique())])
print(f"\nLevene's Test (std brainPAD): W-statistic={w:.4f}, p-value={p_value}")
...
for covariate in covariates:
    ...
    # Print the observed coefficient and the p-value for each covariate
    print(f"Coeficiente observado ({covariate}): {observed_coef}")
    print(f"p-valor de la prueba de permutación ({covariate}): {p_value:.10e}")
...
# Remove rows where the 'ID' column matches any ID in IDs_in_II
crazyALSPAC_3_filtered = crazyALSPAC_3[crazyALSPAC_3['ID'].isin(IDs_in_II)]

# Calculate the average BrainPAD of the remaining participants
average_brainPAD = crazyALSPAC_3_filtered['brainPAD_standardized'].mean()

print(crazyALSPAC_3_filtered['brainPAD_standardized'].tolist())
# print(crazyALSPAC_3_filtered['brainPAD'].tolist())

# Print or return the average brainPAD
print("The average brainPAD of the remaining participants is:", average_brainPAD)
